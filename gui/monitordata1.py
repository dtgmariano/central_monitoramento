...
# Form implementation generated from reading ui file 'monitordata1.ui'
#
# Created: Fri Oct 25 20:23:19 2013
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.lbECGStatus.setText(_translate("Form", "<html><head/><body><p>Normal</p></body></html>", None))
        self.lbPressao.setText(_translate("Form", "000/00 mmmHG", None))
        self.lbO2.setText(_translate("Form", "00 %", None))
        self.lbPaciente.setText(_translate("Form", "<html><head/><body><p>John Doo</p></body></html>", None))
        self.lbFC.setText(_translate("Form", "<html><head/><body><p>00 BPM</p></body></html>", None))
        self.lbTemperatura.setText(_translate("Form", "<html><head/><body><p>00 <span style=\" vertical-align:super;\">o</span>C</p></body></html>", None))
        self.lbMonitor.setText(_translate("Form", "<html><head/><body><p>01</p></body></html>", None))
